...
func TestSwitchProviderModelUsesClineAppSession(t *testing.T) {
	...
	next, text, ok, _, _ := m.switchProviderModel("cline", "cline-pass/glm-5.2")
...
func TestSwitchProviderModelRejectsClineWithoutAppSession(t *testing.T) {
	...
	_, text, ok, _, _ := m.switchProviderModel("cline", "cline-pass/glm-5.2")
...
func TestSwitchProviderModelUsesOpenCodeGoAuthJSON(t *testing.T) {
	...
	next, text, ok, _, _ := m.switchProviderModel("opencode-go", "deepseek-v4-pro")
...
func TestSwitchProviderModelRejectsOpenCodeGoWithoutAuthJSON(t *testing.T) {
	...
	_, text, ok, _, _ := m.switchProviderModel("opencode-go", "deepseek-v4-pro")
