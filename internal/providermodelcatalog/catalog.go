...
var curatedModels = map[string][]Model{
	...
	"opencode-go": {
		...
		{ID: "glm-5.2", Description: "GLM 5.2"},
		{ID: "glm-5.3", Description: "GLM 5.3"},
		{ID: "glm-5.1", Description: "GLM 5.1"},
		{ID: "glm-5", Description: "GLM 5"},
		{ID: "kimi-k2.7-code", Description: "Kimi K2.7 Code"},
		{ID: "kimi-k3", Description: "Kimi K3"},
		{ID: "kimi-k2.6", Description: "Kimi K2.6"},
		{ID: "kimi-k2.5", Description: "Kimi K2.5"},
		{ID: "qwen3.8-max", Description: "Qwen 3.8 Max"},
		{ID: "qwen3.7-max", Description: "Qwen 3.7 Max"},
		{ID: "qwen3.7-plus", Description: "Qwen 3.7 Plus"},
		{ID: "qwen3.6-plus", Description: "Qwen 3.6 Plus"},
		{ID: "qwen3.5-plus", Description: "Qwen 3.5 Plus"},
		{ID: "minimax-m3", Description: "MiniMax M3"},
		{ID: "minimax-m2.7", Description: "MiniMax M2.7"},
		{ID: "minimax-m2.5", Description: "MiniMax M2.5"},
		{ID: "mimo-v2.5-pro", Description: "MiMo V2.5 Pro"},
		{ID: "mimo-v2.5", Description: "MiMo V2.5"},
		{ID: "mimo-v2-pro", Description: "MiMo V2 Pro"},
		{ID: "mimo-v2-omni", Description: "MiMo V2 Omni"},
		{ID: "hy3", Description: "Tencent HY3"},
		{ID: "hy3-preview", Description: "Tencent HY3 Preview"},
		{ID: "gpt-5.6-luna", Description: "GPT-5.6 Luna"},
		{ID: "grok-4.5", Description: "Grok 4.5"},
	},
